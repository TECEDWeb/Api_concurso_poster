...
router.get('/:id/editar', authMiddleware, roleMiddleware(['admin', 'coordinador']), evaluacionController.getEvaluacionParaEditar);
...
router.put('/:id/actualizar', authMiddleware, roleMiddleware(['admin', 'coordinador']), evaluacionController.actualizarEvaluacion);
router.post('/:id/finalizar', authMiddleware, evaluacionController.finalizarEvaluacion);
router.put('/:id/reabrir', authMiddleware, roleMiddleware(['admin', 'coordinador']), evaluacionController.reabrirEvaluacion);
